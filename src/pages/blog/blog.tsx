...
const examplePosts: BlogPostSummary[] = [
  {
    ...
    content: 'Probate administration requires careful planning, accurate documentation, and sound legal guidance. This example article outlines the practical steps involved in estate administration in Kenya.',
  },
  {
    id: 'sample-2',
    ...
    content: 'Conveyancing in Kenya involves due diligence, agreements, transfer documentation, and registration safeguards that protect both the buyer and the seller.',
  },
  {
    id: 'sample-3',
    ...
    content: 'Collateral and banking securities should be structured and documented carefully to ensure legal enforceability and protection for all parties involved.',
  },
  {
    id: 'sample-4',
  ...
  },
  {
    ...
    content: 'Startups need a strong legal foundation from incorporation through funding agreements and day-to-day governance.',
  },
  {
    id: 'sample-6',
    ...
    content: 'Legal compliance reviews help businesses identify gaps, improve controls, and reduce exposure to regulatory penalties.',
  },
];
        ...
        const dbPosts = Array.isArray(data?.nodes)
          ? data.nodes.map((post: any) => ({
              ...
              author: {
                ...
                href: '#',
                imageUrl: post.author?.imageUrl || post.imageUrl || '/profile.png',
              },
              ...
              <article key={post.id} className="flex flex-col items-start justify-between max-w-xs min-w-[320px] flex-shrink-0 snap-center bg-white rounded-lg shadow p-4">
                ...
                <div className="relative flex items-center mt-8 gap-x-4">
                  <img
                    ...
                    className="rounded-full object-fit size-10 bg-gray-50"
                  />
