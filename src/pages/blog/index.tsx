      ...
      <div className="py-24 bg-white bg sm:py-32">
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-2 text-light text-lg/8">Trusted Legal Perspectives.</p>
          </div>
              ...
              <article key={post.id} className="flex flex-col items-start justify-between max-w-xl">
                <div className="flex items-center text-xs gap-x-4">
                  ...
                  <a
                    ...
                    className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-light hover:bg-gray-100"
                  >
                    {post.category.title}
                  </a>
                </div>
                <div className="relative group">
                  <h3 className="mt-3 font-semibold text-light text-lg/6 group-hover:text-gray-600">
                    <a href={post.href}>
