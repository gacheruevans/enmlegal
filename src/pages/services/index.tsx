...
export const Services = () => {
  ...
  return (
    <div className="relative py-24 overflow-hidden bg-white border border-b-1 border-b-light sm:py-32 isolate">
      <img
        alt="services"
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:text-center">
          ...
          <p className="mt-6 text-light text-lg/2">
        ...
        <div className="max-w-3xl mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-4xl">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative p-2 pl-16 rounded-md bg-white/20 backdrop-blur-sm">
                <dt className="font-semibold text-gray-900 text-base/7">
                  <div className="absolute top-0 left-0 flex items-center justify-center rounded-lg bg-neutral size-10">
                    <feature.icon aria-hidden="true" className="text-white size-6" />
                  </div>
                  <p className="text-white">{feature.name}</p>
                </dt>
                <dd className="mt-2 text-light text-base/7">{feature.description}</dd>
              </div>
            ))}
          </dl>
        </div>
